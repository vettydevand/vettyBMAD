...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to expansion-packs/bmad-2d-unity-game-dev/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → expansion-packs/bmad-2d-unity-game-dev/tasks/create-doc.md
...
activation-instructions:
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for development standards for this project - expansion-packs/bmad-2d-unity-game-dev/core-config.yaml devLoadAlwaysFiles list
  - CRITICAL: The path for the Unity Editor is specified by unityEditorLocation in expansion-packs/bmad-2d-unity-game-dev/core-config.yaml
