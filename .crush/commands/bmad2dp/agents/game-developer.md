...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to expansion-packs/bmad-2d-phaser-game-dev/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → expansion-packs/bmad-2d-phaser-game-dev/tasks/create-doc.md
